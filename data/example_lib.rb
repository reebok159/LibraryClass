module Generator
  def init
    ...
    lib.addItem(author1, author1, author3, author4, author5)
    ...
    lib.addItem(book11, book12, book13)
    ...
    lib.addItem(book41, book42, book43)
    ...
    lib.addItem(book51, book52, book53, book54)
    ...
    lib.addItem(reader1, reader2, reader3, reader4)
    ...
    lib.addItem(order1, order2, order3, order4, order5, order6, order7, order8)
    ...
    lib.addItem(order9, order10, order11, order12)
